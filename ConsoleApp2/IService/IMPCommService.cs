...
namespace MessagePassingComm
{
  ...
  public struct ServiceEnvironment
  {
    ...
    {
        public const string fileStorage = "../../../ConsoleApp2/RepoStorage";
        public const long blockSize = 1024;
        public static string baseAddress { get; set; }
        public static bool verbose { get; set; }
    }
    ...
    {
        public const string fileStorage = "../../../MockTestHarness/TestStorage";
        public const long blockSize = 1024;
        public static string baseAddress { get; set; }
        public static bool verbose { get; set; }
    }
    ...
    {
        public const string fileStorage = "../../../MotherBuilder/buildStorage";
        public const long blockSize = 1024;
        public static string baseAddress { get; set; }
        public static bool verbose { get; set; }
    }
  ...
  public interface IMessagePassingComm
  {
    ...
    [OperationContract]
    bool openFileForWrite(string name,string flag,string location);
